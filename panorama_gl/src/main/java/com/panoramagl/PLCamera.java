...
public class PLCamera extends PLRenderableElementBase implements PLICamera {
    ...
    public int getZoomLevel() {
        return (mFovRange.min != mFovRange.max ? Math.round((mFovRange.max - mFov) / ((mFovRange.max - mFovRange.min) / mZoomLevels)) : 0);
    }
    ...
    public boolean stopAnimation() {
        return (mIsNotLocked && this.internalStopAnimation(null));
    }

    @Override
    public boolean stopAnimation(Object sender) {
        return (mIsNotLocked && this.internalStopAnimation(sender));
    }
    ...
    public boolean setFovFactor(float fovFactor, boolean animated) {
        return (mIsNotLocked && fovFactor >= 0.0f && fovFactor <= 1.0f && this.setFov(null, this.convertFovFactorToFov(fovFactor), animated));
    }

    @Override
    public boolean setFovFactor(Object sender, float fovFactor, boolean animated) {
        return (mIsNotLocked && fovFactor >= 0.0f && fovFactor <= 1.0f && this.setFov(sender, this.convertFovFactorToFov(fovFactor), animated));
    }
    ...
    public boolean addFov(Object sender, float distance) {
        return (mIsNotLocked && this.setInternalFov(sender, mFov - (distance / PLConstants.kDisplayPPIBaseline * mFovSensitivityByDisplayPPI), false, true, false));
    }
    ...
    public boolean setZoomFactor(float zoomFactor, boolean animated) {
        return (mIsNotLocked && zoomFactor >= 0.0f && zoomFactor <= 1.0f && this.setFovFactor(null, 1.0f - zoomFactor, animated));
    }

    @Override
    public boolean setZoomFactor(Object sender, float zoomFactor, boolean animated) {
        return (mIsNotLocked && zoomFactor >= 0.0f && zoomFactor <= 1.0f && this.setFovFactor(sender, 1.0f - zoomFactor, animated));
    }
    ...
    public boolean lookAt(PLRotation rotation) {
        return (mIsNotLocked && this.internalLookAt(null, rotation.pitch, rotation.yaw, false, true, false));
    }

    @Override
    public boolean lookAt(Object sender, PLRotation rotation) {
        return (mIsNotLocked && this.internalLookAt(sender, rotation.pitch, rotation.yaw, false, true, false));
    }
    ...
    public boolean lookAt(float pitch, float yaw) {
        return (mIsNotLocked && this.internalLookAt(null, pitch, yaw, false, true, false));
    }

    @Override
    public boolean lookAt(Object sender, float pitch, float yaw) {
        return (mIsNotLocked && this.internalLookAt(sender, pitch, yaw, false, true, false));
    }
    ...
    public boolean lookAtAndFovFactor(float pitch, float yaw, float fovFactor, boolean animated) {
        return (mIsNotLocked && fovFactor >= 0.0f && fovFactor <= 1.0f && this.lookAtAndFov(null, pitch, yaw, this.convertFovFactorToFov(fovFactor), animated));
    }

    @Override
    public boolean lookAtAndFovFactor(Object sender, float pitch, float yaw, float fovFactor, boolean animated) {
        return (mIsNotLocked && fovFactor >= 0.0f && fovFactor <= 1.0f && this.lookAtAndFov(sender, pitch, yaw, this.convertFovFactorToFov(fovFactor), animated));
    }

    @Override
    public boolean lookAtAndZoomFactor(float pitch, float yaw, float zoomFactor, boolean animated) {
        return (mIsNotLocked && zoomFactor >= 0.0f && zoomFactor <= 1.0f && this.lookAtAndFov(null, pitch, yaw, this.convertFovFactorToFov(1.0f - zoomFactor), animated));
    }

    @Override
    public boolean lookAtAndZoomFactor(Object sender, float pitch, float yaw, float zoomFactor, boolean animated) {
        return (mIsNotLocked && zoomFactor >= 0.0f && zoomFactor <= 1.0f && this.lookAtAndFov(sender, pitch, yaw, this.convertFovFactorToFov(1.0f - zoomFactor), animated));
    }
